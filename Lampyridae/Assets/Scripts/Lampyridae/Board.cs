   ...
   private void SetUp()
   {
      for (int i = 0; i < width; i++)
      {
         for (int j = 0; j < height; j++)
         {
            ...
            Vector2 tilePosistion = new Vector2(i, j);
            GameObject backgroundTile = Instantiate(tilePrefab, tilePosistion, Quaternion.identity) as GameObject;
